...
const fileContent = `// EKKAYI Complete Luxury Furniture Catalog
...
fs.writeFileSync(path.join(__dirname, '../data/products.js'), fileContent, 'utf8');
console.log('Successfully updated src/data/products.js with 100% genuine luxury furniture items!');
